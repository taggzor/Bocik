...
var kickCommand = /** @class */ (function () {
    ...
    kickCommand.prototype.help = function () {
        return "Wyrzuć z serwera";
    };
    kickCommand.prototype.itc = function (command) {
        return command === this._command;
    };
    kickCommand.prototype.rc = function (args, msg, client) {
        return __awaiter(this, void 0, void 0, function () {
            var mU, reason, klog;
            return __generator(this, function (_a) {
                mU = msg.mentions.users.first();
                reason = args.slice(1).join(" ") || "(brak powodu)";
                klog = msg.author.username + " wyrzuci\u0142 za " + reason;
                msg.delete();
