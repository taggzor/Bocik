...
var purgeCommand = /** @class */ (function () {
    function purgeCommand() {
        this._command = "purge";
    }
    purgeCommand.prototype.help = function () {
        return "Usun podaną liczbę wiadomości";
    };
    purgeCommand.prototype.itc = function (command) {
        return command === this._command;
    };
    purgeCommand.prototype.rc = function (args, msg, client) {
